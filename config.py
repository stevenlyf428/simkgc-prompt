...
parser.add_argument("--template", type=str, default="(1,1,1,1,1)")
...
assert args.task.lower() in ['wn18rr', 'fb15k237', 'wiki5m_ind', 'wiki5m_trans','wn18rr_ind', 'fb15k237_ind','fb15k-237-n','wiki27k','fb15k-237-owe','fb20k']
