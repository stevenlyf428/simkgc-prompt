...
parser.add_argument('--max-num-tokens', default=100, type=int,
...
assert args.pooling in ['cls', 'mean', 'max', "mask"]
assert args.task.lower() in ['wn18rr', 'fb15k237', 'wiki5m_ind', 'wiki5m_trans','wn18rr_ind', 'fb15k237_ind']
