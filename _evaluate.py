...
from _predict import BertPredictor
...
def predict_by_split():
    ...
    # ent_tr_tensor = predictor.predict_by_entities(entity_dict.entity_exs,relation)
...
def eval_single_direction(predictor: BertPredictor,
    ...
    # hr_tensor, _ ,tr_tensor = predictor.predict_by_examples(examples,entity_dict.entity_exs)
    # # ent_tr_tensor = predictor.predict_by_entities_tr(examples, entity_exs)
