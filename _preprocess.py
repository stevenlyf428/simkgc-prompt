...
parser.add_argument('--task', default='wiki5m_ind', type=str, metavar='N',
                    help='dataset name')
parser.add_argument('--workers', default=8, type=int, metavar='N',
                    help='number of workers')
parser.add_argument('--train-path', default='/mnt/data/data/home/liuyafei/论文2/temp/SimKGC-prompt/data/wiki5m_ind/wikidata5m_inductive_train.txt', type=str, metavar='N',
                    help='path to training data')
parser.add_argument('--valid-path', default='/mnt/data/data/home/liuyafei/论文2/temp/SimKGC-prompt/data/wiki5m_ind/wikidata5m_inductive_valid.txt', type=str, metavar='N',
                    help='path to valid data')
parser.add_argument('--test-path', default='/mnt/data/data/home/liuyafei/论文2/temp/SimKGC-prompt/data/wiki5m_ind/wikidata5m_inductive_test.txt', type=str, metavar='N',
                    help='path to valid data')
