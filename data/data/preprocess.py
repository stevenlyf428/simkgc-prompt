...
parser.add_argument('--test-path', default='/mnt/data/data/home/liuyafei/论文2/temp/SimKGC-prompt/data/FB15k-237-OWE/test.txt', type=str, metavar='N',
                    help='path to valid data')
...
def preprocess_fb15k237(path):
    ...
    if not fb15k_id2desc or not fb15k_id2ent:
        _load_fb15k237_data_from_json('/mnt/data/data/home/liuyafei/论文2/temp/SimKGC-prompt/data/FB15k-237-OWE/entity2wikidata.json')
